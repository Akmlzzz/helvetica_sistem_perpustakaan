            ...
            <div class="max-w-full overflow-x-auto">
                <table class="w-full table-auto">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                    <div class="h-16 w-24 rounded-md overflow-hidden">
                                        <img src="{{ Storage::url($banner->bg_img) }}" alt="BG"
                                ...
                                <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">
                                        {{ is_array($banner->tags) ? implode(', ', $banner->tags) : $banner->tags }}
                                    </p>
                                </td>
                                <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                    <span
                                        class="inline-flex rounded-full bg-{{ $banner->is_active ? 'success' : 'danger' }}/10 px-3 py-1 text-sm font-medium text-{{ $banner->is_active ? 'success' : 'danger' }}">
                                    ...
                                    <div class="flex items-center space-x-3.5">
                                        <a href="{{ route('admin.hero-banners.edit', $banner->id) }}"
                                            ...
                                            <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M8.99981 14.8219C3.43106 14.8219 0.674805 9.50624 0.562305 9.28124C0.47793 9.11249 0.47793 8.88749 0.562305 8.71874C0.674805 8.49374 3.43106 3.17812 8.99981 3.17812C14.5686 3.17812 17.3248 8.49374 17.4373 8.71874C17.5217 8.88749 17.5217 9.11249 17.4373 9.28124C17.3248 9.50624 14.5686 14.8219 8.99981 14.8219ZM1.88418 8.99999C2.55918 10.1812 4.97793 13.5 8.99981 13.5C13.0217 13.5 15.4404 10.1812 16.1154 8.99999C15.4404 7.81874 13.0217 4.49999 8.99981 4.49999C4.97793 4.49999 2.55918 7.81874 1.88418 8.99999Z"
                                                    fill="" />
                                                <path
                                                    d="M9.00019 11.3906C7.67832 11.3906 6.60957 10.3219 6.60957 9C6.60957 7.67813 7.67832 6.60938 9.00019 6.60938C10.3221 6.60938 11.3908 7.67813 11.3908 9C11.3908 10.3219 10.3221 11.3906 9.00019 11.3906ZM9.00019 7.93125C8.40957 7.93125 7.93145 8.40938 7.93145 9C7.93145 9.59063 8.40957 10.0688 9.00019 10.0688C9.59082 10.0688 10.0689 9.59063 10.0689 9C10.0689 8.40938 9.59082 7.93125 9.00019 7.93125Z"
                                                    fill="" />
                                            </svg>
                                        </a>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-4 py-5 text-center text-gray-500">Belum ada banner yang ditambahkan.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
