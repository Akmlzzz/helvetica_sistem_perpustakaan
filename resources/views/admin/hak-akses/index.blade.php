...
<div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10" x-data="hakAksesManager()">
    ...
    <div class="mb-8 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">
                Konfigurasikan fitur apa saja yang dapat diakses oleh setiap <span class="font-semibold text-brand-primary">Petugas</span>.
            </p>
        </div>
    ...
    @if($petugas->isEmpty())
        ...
        <div class="rounded-2xl border border-gray-100 bg-white p-16 text-center shadow-sm">
            ...
            <p class="mb-6 text-sm text-gray-500">Tambahkan akun petugas terlebih dahulu di menu <strong>Kelola Pengguna</strong>.</p>
                ...
                <div class="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm transition-all hover:shadow-md">
                    ...
                    <div class="flex items-center justify-between gap-4 border-b border-gray-100 bg-gray-50 px-6 py-4">
                        <div class="flex items-center gap-4">
                            {{-- Avatar --}}
                            <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-linear-to-br from-brand-primary to-blue-600 text-white font-bold text-lg shadow-sm">
                        ...
                        <div class="flex items-center gap-3">
                            <div class="hidden sm:block">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span id="progress-text-{{ $p->id_pengguna }}" class="text-xs font-semibold text-gray-500">{{ $totalDimiliki }}/{{ $totalFitur }} fitur</span>
                                </div>
                            </div>
                            <span id="badge-{{ $p->id_pengguna }}" class="rounded-full px-3 py-1 text-xs font-bold
                            ...
                            <div class="flex items-center justify-between gap-4 px-6 py-4 transition-colors
                                ...
                                <div class="flex items-center gap-3">
                                    <div class="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg
                                        {{ $aktif ? ($fitur['warna'] === 'blue' ? 'bg-blue-100' : ($fitur['warna'] === 'green' ? 'bg-green-100' : ($fitur['warna'] === 'purple' ? 'bg-purple-100' : 'bg-red-100'))) : 'bg-gray-100' }}
                                        transition-colors">
                                        @if($fitur['icon'] === 'tag')
                                ...
                                <div class="flex items-center gap-2 shrink-0">
                                    ...
                                    <button
                                        ...
                                        data-url="{{ $toggleUrl }}"
                                        data-fitur="{{ $key }}"
                                        data-pengguna="{{ $p->id_pengguna }}"
                                        data-aktif="{{ $aktif ? 'true' : 'false' }}"
                                        onclick="toggleHakAkses(this)"
