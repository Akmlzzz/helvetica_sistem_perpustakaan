            ...
            <form method="GET" action="{{ route('admin.buku.index') }}"
                ...
                <div class="relative w-full sm:w-1/2">
                    <button class="absolute left-4 top-1/2 -translate-y-1/2">
                        <svg class="fill-current text-black dark:text-white hover:text-primary transition-colors" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="min-w-[1000px]">
                    <div class="grid grid-cols-6 rounded-sm bg-gray-2 dark:bg-meta-4 sm:grid-cols-6">
                        <div class="p-2.5 xl:p-5">
                            <h5 class="text-sm font-medium uppercase xsm:text-base">Cover</h5>
                        </div>
                        <div class="p-2.5 xl:p-5">
                            <h5 class="text-sm font-medium uppercase xsm:text-base">Judul & ISBN</h5>
                        </div>
                        <div class="p-2.5 xl:p-5">
                        ...
                        <div class="p-2.5 text-center xl:p-5">
                            <h5 class="text-sm font-medium uppercase xsm:text-base">Lokasi</h5>
                        </div>
                        <div class="p-2.5 text-center xl:p-5">
                    ...
                    @foreach($buku as $item)
                        <div class="grid grid-cols-6 border-b border-stroke dark:border-strokedark sm:grid-cols-6">
                            ...
                            <div class="flex items-center justify-center p-2.5 xl:p-5">
                                <span
                                    class="inline-flex rounded-full bg-opacity-10 px-3 py-1 text-sm font-medium {{ $item->stok > 0 ? 'bg-success text-success' : 'bg-danger text-danger' }}">
                                    {{ $item->stok }}
                                </span>
                            </div>
                            ...
                            <div class="flex items-center justify-center p-2.5 xl:p-5">
                                <div class="flex items-center space-x-3.5" x-data="{ editOpen: false }">
                                     ...
                                     <a href="#" class="hover:text-primary border border-stroke dark:border-strokedark rounded-md p-1.5" title="Cetak Barcode">
                                        <svg class="fill-current" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M3 7V5a2 2 0 012-2h2m10 0h2a2 2 0 012 2v2m0 10v2a2 2 0 01-2 2h-2M7 21H5a2 2 0 01-2-2v-2" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M7 9v6M10 9v6M14 9v6M17 9v6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                    </a>
                                    <form action="{{ route('admin.buku.destroy', $item->id_buku) }}" method="POST"
                                        ...
                                        @csrf
                                        @method('DELETE')
                                         <button type="submit" class="hover:text-primary border border-stroke dark:border-strokedark rounded-md p-1.5">
