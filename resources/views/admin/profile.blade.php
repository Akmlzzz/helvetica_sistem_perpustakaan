    ...
    <div class="mx-auto max-w-270">
        <div class="grid grid-cols-1 gap-9">
            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <form action="{{ route('admin.profile.update') }}" method="POST" x-data="{ showModal: false }" enctype="multipart/form-data"
                        ...
                        <div class="mb-4.5" x-data="profileCropper()">
                            <div class="flex flex-col sm:flex-row sm:items-center gap-6">
                                ...
                                <div class="flex-1">
                                    ...
                                    @if($user->foto_profil)
                                        <div class="mt-3">
                                            <button type="button" onclick="if(confirm('Yakin ingin menghapus foto profil?')) document.getElementById('delete-foto-form').submit();" class="text-sm font-medium text-meta-1 hover:underline flex items-center gap-1">
                            ...
                            <form id="delete-foto-form" action="{{ route('admin.profile.hapus-foto') }}" method="POST" class="hidden">
                                @csrf
                                @method('DELETE')
                            </form>
