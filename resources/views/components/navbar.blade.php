<div class="sticky top-0 z-50 w-full bg-white shadow-md">
    <nav class="container mx-auto px-6 py-4" x-data="{ isOpen: false }">
        <div class="flex items-center justify-between">
            ...
            @else
                <a href="{{ route('login') }}"
                    class="hidden rounded-full border border-gray-200 bg-white px-6 py-2 text-sm font-medium text-gray-700 transition hover:bg-gray-50 lg:inline-flex">
                    Masuk
                </a>
            @endauth

            <!-- Hamburger Button (Mobile) -->
            <button @click="isOpen = !isOpen" class="flex lg:hidden text-gray-700 focus:outline-none">
        ...
        <div x-show="isOpen" x-transition:enter="transition ease-out duration-200"
            ...
            class="absolute left-0 right-0 top-full z-50 flex w-full flex-col gap-4 border-t border-gray-100 bg-white p-4 shadow-lg lg:hidden">
            <a href="#beranda"
