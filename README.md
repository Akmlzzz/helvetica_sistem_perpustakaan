...
<img src="public/img/readme-img/dashboard-petugas.png" width="800">
...
<img src="public/img/readme-img/chatbot-ai.JPG" width="800">
...
6. **Migrasikan Struktur Tabel Basis Data dan Isi Data Dummy:**
   *(Langkah ini otomatis men-generate data sampel, termasuk admin, petugas, tipe kategori, dll.)*
   ```bash
...
8. **Proses Akhir: Menghidupkan Layanan Server Terpadu**
   ...
   npm run dev
   ```
   *Buka http://127.0.0.1:8000 di bilah alamat browser pilihan Anda.*
